				...
				if ($existingRecord) {
					...
					if ($studentData) {
						...
						try {
							...
							$mail->isHTML(true);
							$mail->Subject = 'Thank you for application';
							$mail->Body = '<div style=" padding: 10px;">Hello ' . $surname . ',<br/>Thank you for your application for Import permit<br/><br/>.Sincerely!</div>';
